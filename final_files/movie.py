ret_files = '/gpfs/CompMicro/Projects/virtualstaining/u2os_leonetti/2019_04_11_Ivan_Dividing_U2OS_v3/2019_04_11_HEK_U2OS_CollagenCoating/2019_04_11_U2OS_plin2_Col_Dividing2_Phase_3D_all_z/dividing_2/retardance/'
orientation_files = '/gpfs/CompMicro/Projects/virtualstaining/u2os_leonetti/2019_04_11_Ivan_Dividing_U2OS_v3/2019_04_11_HEK_U2OS_CollagenCoating/2019_04_11_U2OS_plin2_Col_Dividing2_Phase_3D_all_z/dividing_2/orientation/'
...
for frame in range(2):
    ...
    anisotropy = cv2.imread(ret_files + 'img_retardance_t0' + "{0:0=2d}".format(frame) + '_p000_z003.tif', -1).astype('float32')
    retardance = cv2.imread(orientation_files + 'img_orientation_t0' + "{0:0=2d}".format(frame) + '_p000_z003.tif', -1).astype('float32')
...
#         np.save('iter_pos/fp_' + dataset + '_alpha_' + str(alpha) + '_numpoints_' + str(final_num_points) + '_drag_' + str(c_drag) + '_iter_' + str(k), curr_points)
    ...
    np.save('fp_' + dataset + '_alpha_' + str(alpha) + '_numpoints_' + str(final_num_points) + '_drag_' + str(c_drag) + '_frame_' + str(frame), final_positions)
